...
It fetches current location of the user andd displays the nearby services.
...
To use this project download all the files on your system and replace "your-api-key" with API key provided by google.
